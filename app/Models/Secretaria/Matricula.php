...
class Matricula extends Model
{
    ...
    protected $fillable = [
        ...
        'valor_entrada_mat_didatico', 'fk_id_forma_pagto_entrada_mat_didatico', 'valor_material_didatico', 'data_venc_parcela_um_mat_didatico', 'data_pagto_mat_didatico', 'fk_id_forma_pagto_didatico', 'qt_parcelas_mat_didatico',
