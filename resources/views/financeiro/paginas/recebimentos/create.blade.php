        ...
        <form action="{{ route('recebimento.store', $recebivel->id_pessoa)}}" class="form" name="form" method="POST">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-3">
                        <label>Valor:</label>
                        <input type="number" name="valor_principal" id="valor_principal" step="0.010" required readonly class="form-control" value="{{ $recebivel->valor_principal ?? old('valor_principal') }}">
                    </div>
                
                    <div class="col-sm-3">
                        <label>Valor Desconto:</label>
                    <input type="number" step="0.010" class="form-control" name="valor_desconto_principal" id="valor_desconto_principal" value="{{$recebivel->valor_desconto_principal ?? old('valor_desconto_principal')}}" onBlur="recalcularValor('valor_principal', 'valor_desconto_principal', 'valor_desconto_principal', 'valor_total'); calcularAcrescimos(); ; somarRecebiveis();" />
                    </div>
                    <div class="col-sm-3">
