        ...
        <form action="{{ route('relatorios.recebiveis')}}" id="diario" name="diario" class="form" method="POST">
            ...
            <div class="row">
                <div class="form-group col-sm-2 col-xs-1">
                    ...
                    <select class="form-control form-control-sm" name="anoLetivo" id="anoLetivo" >
                        <option value=""></option>                        
                ...
                <div class="form-group col-sm-5 col-xs-2">
                    ...
                    <select name="turma" id="turma" class="form-control form-control-sm"> 
                        <option value=""></option>
                    </select>
                </div> 
            </div>
            ...
            <div class="row">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tipo_relatorio" id="listagem" value="listagem" required checked>
