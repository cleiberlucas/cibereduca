                    ...
                    <td colspan=2>
                        ...
                        @if ($matricula->qt_parcelas_curso > 1)
                            ...
                            @if (isset($matricula->data_venc_parcela_um))
                                {{nomeMesMinusculo(date('m', strtotime($matricula->data_venc_parcela_um) ) )}} de {{date('Y', strtotime($matricula->data_venc_parcela_um)) }}    
                                a {{nomeMesMinusculo(date('m', strtotime($matricula->data_venc_parcela_um))+$matricula->qt_parcelas_curso-1) }}  
                                de 
